...
function Footer() {
    return ( 
        <div>
            <footer className="mt-5 border-top p-4" style={{backgroundColor: "rgb(250,250,250)"}}>
                <div className="container  p-2 ">

                    <div className="row mb-4 ">
                        <div className="col">
                            <img src="media/logo.svg" style={{width:"120px"}} alt="" />
                            <p>© 2010 - 2024, Zerodha Broking Ltd.
    All rights reserved.</p>
                        </div>

                        <div className="col ru">
                            <p>Company</p>
                            <a href="">About</a><br />
                    ...
                    <div className="mt-5 text-small text-muted ru">
                        <p>Zerodha Broking Ltd.: Member of NSE, BSEMCX – SEBI Registration no.: INZ000031633 CDSL/NSDL: Depository services through Zerodha Broking Ltd. – SEBI Registration no.: IN-DP-431-2019 Commodity Trading through Zerodha Commodities Pvt. Ltd. MCX: 46025; NSE-50001 – SEBI Registration no.: INZ000038238 Registered Address: Zerodha Broking Ltd., #153/154, 4th Cross, Dollars Colony, Opp. Clarence Public School, J.P Nagar 4th Phase, Bengaluru - 560078, Karnataka, India. For any complaints pertaining to securities broking please write to complaints@zerodha.com, for DP related to dp@zerodha.com. Please ensure you carefully read the Risk Disclosure Document as prescribed by SEBI | ICF</p>
                    ...
                    <div className="row text-center text-muted ru " style={{fontSize:"13px"}}>
                        ...
                        <div className="col"><a href="">For investors attention</a></div>
                        <div className="col"><a href="">Investors charter</a></div>
                    </div>                    
                </div>
            </footer>
